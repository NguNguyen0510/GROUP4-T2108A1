...
<div id="box">
    <div class="btn-sss">
        <a style="color: white;
        text-decoration: none;" href='product.php'>Đặt thêm món mới</a></div>
...
<th></th>
        ...
        while ($order_data = mysqli_fetch_array($result)){
            ...
            echo "<td><a href='updateorder.php?id=$order_data[id]' style='color: #0005b0;text-decoration: none'>Chỉnh sửa</a> 
            <br></td></tr>";
        }
        ?>
