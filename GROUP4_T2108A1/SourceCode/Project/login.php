    ...
    <div.a>
        ...
        <div class="wrapper">
            ...
            <?php echo (!empty($username_err)) ? 'is-invalid' : ''; ?>" value="
                ...
                <p class="df" style="color:white;font-size: 18px">Bạn chưa có tài khoản?<a style="color: yellow" href="register.php">Đăng kí ngay</a>.</p>


                <p class="df" style="color:white;margin-top: -100px;margin-left: -20px;font-size: 18px">Bạn là quản trị viên?<a style="color: yellow" href="logadmin.php">Đăng nhập với tư cách quản trị viên</a>.</p>
